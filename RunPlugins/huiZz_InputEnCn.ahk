...
;-----------------------------------------------------------
{
    ...
    result := SendMessage(0x283, 0x006, setSts, , "ahk_id " DefaultIMEWnd)
...
HK1_LButton() { ; V1toV2: HK->Func
	global
	Sleep(200)
	Ime_En_Or_Cn() ; V1toV2: Gosub
return
}
;##############################################
HK2_Alt____Tab() { ; V1toV2: HK->Func
	global
	Sleep(500)
	Ime_En_Or_Cn() ; V1toV2: Gosub
return
